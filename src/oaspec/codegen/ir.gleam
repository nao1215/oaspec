...
pub opaque type Module {
  Module(
    ...
    header_records: List(ResponseHeaderRecord),
  )
}
...
pub fn module(
  ...
  Module(header:, imports:, declarations:, header_records: [])
}
...
pub fn module_header_records(m: Module) -> List(ResponseHeaderRecord) {
  m.header_records
}
